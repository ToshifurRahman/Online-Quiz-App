...
const QuizMain = () => {
  ...
  return (
    <div className="text-white sm:w-[50%]  my-20 mx-5  sm:mx-auto lg:w-[500px] drop-shadow-lg bg-[#524C42] rounded-3xl">
      <form className="p-12 " onSubmit={handleQuizLogin}>
        <h1 className="backdrop-blur-sm text-4xl pb-8">Enter Quiz</h1>
        <div className="space-y-5">
          ...
          <div className="relative">
            <input
              ...
              placeholder="quizId"
              className="bg-[#E2DFD0] text-black caret-black rounded-2xl p-3 block w-full pl-10 drop-shadow-lg outline-none"
            />
